...
import { ArrowLeft, BadgeCheck, LockKeyhole, Phone, ShieldCheck, Sparkles } from 'lucide-react';
    ...
    <div className="mx-auto w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl shadow-slate-900/12">
      <div className="relative overflow-hidden bg-slate-950 px-7 py-8 text-white">
        ...
        <div className="relative">
          ...
          <p className="mt-3 text-sm leading-6 text-blue-50/78">Book trusted professionals and track your home service visits securely.</p>
        </div>
      </div>
